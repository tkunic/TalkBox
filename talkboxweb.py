...
"""talkboxweb.py: TalkBox Web Daemon."""
...
start_tb_cmd = "sudo /etc/init.d/talkbox.sh start"
stop_tb_cmd = "sudo /etc/init.d/talkbox.sh stop"

start_process = subprocess.Popen(start_tb_cmd.split(), stdout=subprocess.PIPE)
...
<form method="POST" enctype="multipart/form-data" action="">\n"""
    ...
    def POST(self):
		...
		stop_process = subprocess.Popen(stop_tb_cmd.split(), stdout=subprocess.PIPE)
		start_process = subprocess.Popen(start_tb_cmd.split(), stdout=subprocess.PIPE)
